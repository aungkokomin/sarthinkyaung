    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{url('admin')}}">Sar Thin Kyaung</a>
            </div>
            <!-- Top Menu Items -->
...
<!--                 <li class="dropdown">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="{{url('admin/category')}}"><i class="fa fa-fw fa-bar-chart-o"></i> Category</a>
                    </li>
                    <li>
                        <a href="{{url('admin/sub-category')}}"><i class="fa fa-fw fa-table"></i> Sub Category</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{url('admin/blank-page')}}"><i class="fa fa-fw fa-file"></i> Blank Page</a>
                    </li>
                    <li>
                        <a href="{{url('admin/rtl')}}"><i class="fa fa-fw fa-dashboard"></i> RTL Dashboard</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
