        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('admin/course/'.$course->id.'/edit') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control" name="title" value="{{$course->title}}" required autofocus placeholder="Course Title">
                        ...
                        <div class="form-group {{ $errors->has('category_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select name="category_id" class="form-control">
                                    ...
                                    <option value="{{$subcategories->id}}" @if($course->category_id) selected @endif>{{$subcategories->name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group {{ $errors->has('start_date') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="datepicker" type="text" class="form-control" name="start_date" value="{{$course->start_date}}" required>
                        ...
                        <div class="form-group {{ $errors->has('course_fee') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                                <input id="course_fee" type="text" class="form-control" name="course_fee" value="{{$course->course_fee}}" required>
